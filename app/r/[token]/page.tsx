    ...
    <div style={{ padding: 14 }}>
      ...
      <div
        style={{
          ...
          borderRadius: 16,
          background: "radial-gradient(circle at 50% 45%, #111827 0%, #0b1220 55%, #070b12 100%)",
        }}
      >
        {/* Center table */}
        <div
      ...
      >
        ...
        <span style={{ color: "#111827", fontWeight: 800 }}>● Open</span>
...
export default function ReservationPage() {
  ...
  // We still use eventId internally (for Firestore path), but we don't display it.
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        const resRef = doc(db, "events", eventId, "reservations", token);
  ...
  return (
    <main style={{ padding: 24, fontFamily: "sans-serif", maxWidth: 980, color: "#111827", background: "#f8fafc" }}>
            ...
            >
              ...
              >
                <input
                  ...
                  style={{ padding: 10, borderRadius: 10, border: "1px solid #111827" }}
                />
      ...
      <section style={{ marginTop: 18 }}>
        ...
        <div style={{ marginTop: 10, opacity: 0.8, fontSize: 12 }}>
          Tip: Tap a seat to claim/unclaim. Seats taken by others won’t be
          clickable.
        </div>
      </section>
    </main>
